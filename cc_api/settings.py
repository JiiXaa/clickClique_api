...
# DRF authentication: tokens not supported for the Browsable API. Session used in development token used in production this set up allows us to use both. Check the DEV value in env.py
REST_FRAMEWORK = {
